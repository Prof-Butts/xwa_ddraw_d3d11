...
bool g_bShowSSAODebug = false, g_bDumpSSAOBuffers = false, g_bEnableIndirectSSDO = false, g_bFadeLights = false, g_bDisplayGlowMarks = true;
bool g_bFNEnable = true, g_bSpecularMappingEnabled = true;
