...
XwaD3DInfo* D3dOptCreateD3DfromTexture(OptNode* A4, int A8, XwaTextureDescription* AC,
	unsigned char* A10, unsigned char* A14, unsigned short* A18, unsigned short* A1C);
