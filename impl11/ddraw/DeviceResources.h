...
public:
	...
	ComPtr<ID3D11PixelShader> _b2pDownsample;
	ComPtr<ID3D11PixelShader> _b2pDownsampleVR;
	ComPtr<ID3D11PixelShader> _b2pUpsample;
	ComPtr<ID3D11PixelShader> _b2pUpsampleVR;
