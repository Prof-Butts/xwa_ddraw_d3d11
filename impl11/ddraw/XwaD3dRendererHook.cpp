...
void D3dOptSetSceneTextureTag(XwaD3DInfo* d3dInfo, OptNode* textureNode)
{
	...
	//log_debug("[DBG] TAG: %s", textureTag.c_str());
}
...
HRESULT D3dOptCreateTextureColorLight(
	XwaD3DInfo* d3dInfo, OptNode* textureNode,
	int textureId, XwaTextureDescription* textureDescription,
	unsigned char* optTextureData, unsigned char* optTextureAlphaData,
	unsigned short* optPalette8, unsigned short* optPalette0)
{
	...
	const char* texName = (char*)d3dInfo->TextureDescription.Palettes;
